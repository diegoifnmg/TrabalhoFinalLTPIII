 ...
 * @author Diego
 */
public class frmGrupoProdutosListagem extends javax.swing.JInternalFrame {

    GrupoProdutosDAO DAO;
    
    /**
     * Creates new form frmGrupoProdutosListagem
     */
    public frmGrupoProdutosListagem() {
        initComponents();
        
        DAO = new GrupoProdutosDAO();

        List<GrupoProdutos> grupoProdutos = DAO.ListarTodosGrupos();

        preencheTabela(grupoProdutos);
    }
    
    private void preencheTabela(List<GrupoProdutos> lista) {
        DefaultTableModel model = new DefaultTableModel();
        model.addColumn("IdGrupoProdutos");
        model.addColumn("Nome");
        
        for (GrupoProdutos g : lista) {
            Vector valores = new Vector();
            valores.add(0, g.getCodGrupoProdutos());
            valores.add(1, g.getNome());
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        GrupoProdutos g = new GrupoProdutos();
        GrupoProdutosDAO d = new GrupoProdutosDAO();
        frmGrupoProdutosEditar janela = new frmGrupoProdutosEditar(g, d);
    ...
    private void tblListagemMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblListagemMouseClicked
        ...
        GrupoProdutos g = DAO.Abrir((int) valor);
        frmGrupoProdutosEditar janela = new frmGrupoProdutosEditar(g, DAO);
        this.getParent().add(janela);
        janela.setVisible(true);
        this.setVisible(false);
